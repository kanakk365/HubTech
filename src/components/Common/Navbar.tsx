...
const Navbar = () => {
  ...
  const Logo = () => (
    ...
    >
      <span className="font-medium text-white">HubTech</span>
    </Link>
  );
  ...
  const ActionButtons = () => (
    <div className="flex items-center gap-4">
      ...
      >
        <Link
          href="/login"
          className="px-4 py-2 rounded-md text-white text-sm font-bold relative cursor-pointer hover:-translate-y-1 transition-all duration-300 ease-out text-center bg-transparent shadow-none hover:scale-105"
        >
          Login
        </Link>
      </motion.div> */}
